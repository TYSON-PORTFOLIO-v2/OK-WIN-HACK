...
<body>
    <div class="container">
        <div class="header">
            <img src="tyson-logo.png" alt="TYSON MODS logo" class="logo-img">
            <h1>TYSON MODS</h1>
        ...
        <div class="content">
            <div class="country-info">
                ...
                <p>Online Users : <span>3169</span></p>
            </div>
            
            <div class="win-notification">
                <p>User 665****796 Win <span class="win-amount">₹5026</span></p>
            </div>
            ...
            <div class="stats">
                ...
                <div class="stat-box">
                    <div class="stat-number">16.2K</div>
            ...
            <a href="https://t.me/TYSON_OK_WIN_HACK" target="_blank" class="register-btn" id="registerBtn">
                START
    ...
    <script>
        document.getElementById('telegramBtn').addEventListener('click', function() {
            ...
            // In a real implementation, this would redirect to the Telegram URL
            // window.location.href = 'https://t.me/TYSON_OWNER';
        });
        
        // Add animation to win amount
        const winAmount = document.querySelector('.win-amount');
        setInterval(() => {
            winAmount.style.transform = 'scale(1.05)';
            setTimeout(() => {
                winAmount.style.transform = 'scale(1)';
            }, 300);
        }, 5000);
